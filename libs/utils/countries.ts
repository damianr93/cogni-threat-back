const countries = [
  ...
  { name: 'Korea, North', code2: 'KP', code3: 'PRK' },
  { name: 'Korea, South', code2: 'KR', code3: 'KOR' },
  ...
  { name: 'Vatican City', code2: 'VA', code3: 'VAT' },
...
export function getCountryName(code2: string): string | undefined {
  return countries.find((country) => country.code2 === code2)?.name;
}

export function getCountryCode2(name: string): string | undefined {
  return countries.find(
    (country) => country.name.toLowerCase() === name.toLowerCase(),
  )?.code2;
}

export function getCountryCode3(code2: string): string | undefined {
  return countries.find((country) => country.code2 === code2)?.code3;
}
...
export function searchCountries(query: string) {
  ...
  return countries.filter(
    (country) =>
      ...
      country.code2.toLowerCase().includes(lowerQuery) ||
